...
LCLIntf, LCLType, LMessages,
  ...
  {$ELSE}
  {$ENDIF}
  SysUtils, ComObj, Classes, Graphics, Controls, variants;
    ...
    IF DocLoaded THEN
      BEGIN
        IF IsExcel THEN
          ...
          END {IF};
        IF IsOpenOffice THEN
          m_vActiveSheet.getCellByPosition(col - 1, row - 1).GetString := strTxt;
  ...
  BEGIN
    ...
    THEN
      BEGIN
        ...
        result:=m_vPrograma.Bridge_GetStruct('com.sun.star.beans.PropertyValue');
