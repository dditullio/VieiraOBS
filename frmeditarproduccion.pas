...
procedure TfmEditarProduccion.zqSenasaCallosAntBeforeOpen(DataSet: TDataSet);
begin
...
procedure TfmEditarProduccion.zqPrincipalhoraSetText(Sender: TField;
  const aText: string);
begin
...
procedure TfmEditarProduccion.paFechaHoraExit(Sender: TObject);
begin
